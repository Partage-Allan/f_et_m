        ...
        <div id="canevas">
            ...
            <h1>Creer une nouvelle news !</h1><br/><br/>     
                        <form method="post" action="creer_news.php"/>
                            Titre : <input type="text" name="titre_new" style="margin-left: 20px;"/><br/><br/>
                            Contenu: <textarea name=contenu_new style="width:300px;height:150px;"></textarea><br/><br/>    
                            <input type="submit" value="Creer news" style="margin-left: 160px"/>
                        </form><br/><br/>
            <?php
                require ("sql.inc.php");
                $sql="INSERT INTO news (titre,contenu) VALUES ('titre_new:'contenu_new')";
